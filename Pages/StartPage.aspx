<%@ page language="C#" autoeventwireup="true" enableeventvalidation="True" validaterequest="false" inherits="PROJETO.StartPage, App_Web_rursx3cf" culture="auto" uiculture="auto" %>
...
<head runat="server">
	...
	<link rel="stylesheet" href="../Styles/StartPage.css?sv=1.0" type="text/css" media="screen" title="no title" charset="utf-8" />
</head>
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script language="JavaScript" src='../JS/Mask.js?sv=1.0' type="text/javascript"></script>
		...
		<script type="text/javascript" src="../JS/StartPage_USER.js?sv=1.0" language="JavaScript"></script>
