<%@ page language="C#" autoeventwireup="true" enableeventvalidation="True" inherits="PROJETO.ViewPage, App_Web_rursx3cf" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../Styles/ViewPage.css?sv=1.0" type="text/css" media="screen" title="no title" charset="utf-8" />
</head>
				...
				<div id="Div1" runat="server" AutoExpandToContent="True" AutoExpandToContentMargin="10">
					...
					<telerik:RadAjaxPanel id="AjaxPanel1" runat="server" ClientEvents-OnRequestStart="OnRequestStart" ClientEvents-OnResponseEnd="OnResponseEnd"
						...
						<telerik:RadGrid id="grdView" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True" AllowSorting="True"
							AutoGenerateColumns="true" EnableLinqExpressions="false" OnItemCommand="grdView_ItemCommand" OnNeedDataSource="grdView_NeedDataSource"
							PageSize="10" RenderMode="Classic" ShowGroupPanel="False" TabIndex="1" TableLayout="Fixed">
