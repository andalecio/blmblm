<%@ page language="C#" enableeventvalidation="True" validaterequest="false" autoeventwireup="true" inherits="PROJETO.Access, App_Web_rursx3cf" culture="auto" uiculture="auto" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
	<link rel="stylesheet" href="../Styles/Access.css?sv=1.0" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<script type="text/javascript" src="../JS/Access_USER.js?sv=1.0" language="JavaScript"></script>
