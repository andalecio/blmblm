<%@ page language="C#" autoeventwireup="true" enableeventvalidation="True" inherits="PROJETO.ConstructorView, App_Web_rursx3cf" culture="auto" uiculture="auto" %>
...
<head runat="server">
	...
	<link rel="stylesheet" href="../Styles/ConstructorView.css?sv=1.0" type="text/css" media="screen" title="no title" charset="utf-8" />
</head>
...
<script type="text/javascript" src="../JS/ConstructorView_USER.js?sv=1.0" language="JavaScript"></script>
