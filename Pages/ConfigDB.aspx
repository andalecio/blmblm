<%@ page language="C#" autoeventwireup="true" enableeventvalidation="True" inherits="PROJETO.ConfigDB, App_Web_rursx3cf" culture="auto" uiculture="auto" %>
...
<head runat="server">
	...
	<link rel="stylesheet" href="../Styles/ConfigDB.css?sv=1.0" type="text/css" media="screen" title="no title" charset="utf-8" />
</head>
<script type="text/javascript" src="../JS/ConfigDB_USER.js?sv=1.0" language="JavaScript"></script>
