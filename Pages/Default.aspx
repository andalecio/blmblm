<%@ page language="C#" autoeventwireup="true" enableeventvalidation="True" validaterequest="false" inherits="PROJETO.Default, App_Web_rursx3cf" culture="auto" uiculture="auto" %>
...
<head runat="server">
	...
	<link rel="stylesheet" href="../Styles/Default.css?sv=1.0" type="text/css" media="screen" title="no title" charset="utf-8" />
</head>
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script language="JavaScript" src='../JS/Mask.js?sv=1.0' type="text/javascript"></script>
		...
		<script type="text/javascript" src="../JS/Default_USER.js?sv=1.0" language="JavaScript"></script>
					...
					<telerik:RadMenu id="mnuMainMenu" runat="server" ClickToOpen="False" CollapseAnimation-Duration="200" CollapseAnimation-Type="OutQuint"
						...
						<Items>
							...
							<telerik:RadMenuItem id="MenuItem28" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
								...
								<Items>
									<telerik:RadMenuItem id="MenuItem30" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
										Text="<%$ Resources: MenuItem30 %>" Value="MenuItem30" />
								</Items>
							</telerik:RadMenuItem>
							<telerik:RadMenuItem id="MenuItem29" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
								Text="<%$ Resources: MenuItem29 %>" Value="MenuItem29">
								<Items>
									<telerik:RadMenuItem id="MenuItem31" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
										Text="<%$ Resources: MenuItem31 %>" Value="MenuItem31" />
									<telerik:RadMenuItem id="MenuItem32" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
										Text="<%$ Resources: MenuItem32 %>" Value="MenuItem32" />
									<telerik:RadMenuItem id="MenuItem33" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
										Text="<%$ Resources: MenuItem33 %>" Value="MenuItem33" />
									<telerik:RadMenuItem id="MenuItem34" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
										Text="<%$ Resources: MenuItem34 %>" Value="MenuItem34" />
									<telerik:RadMenuItem id="MenuItem35" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
										Text="<%$ Resources: MenuItem35 %>" Value="MenuItem35" />
									<telerik:RadMenuItem id="MenuItem36" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
										Text="<%$ Resources: MenuItem36 %>" Value="MenuItem36" />
									<telerik:RadMenuItem id="MenuItem37" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
										Text="<%$ Resources: MenuItem37 %>" Value="MenuItem37" />
									<telerik:RadMenuItem id="MenuItem38" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
										Text="<%$ Resources: MenuItem38 %>" Value="MenuItem38" />
									<telerik:RadMenuItem id="MenuItem39" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
										Text="<%$ Resources: MenuItem39 %>" Value="MenuItem39" />
									<telerik:RadMenuItem id="MenuItem40" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
										Text="<%$ Resources: MenuItem40 %>" Value="MenuItem40" />
									<telerik:RadMenuItem id="MenuItem41" runat="server" Font-Bold="false" Font-Italic="False" Font-Names="Times New Roman" Font-Size="12px"
										Text="<%$ Resources: MenuItem41 %>" Value="MenuItem41" />
								</Items>
							</telerik:RadMenuItem>
						</Items>
					</telerik:RadMenu>
		...
		function ___mnuMainMenuClickHandler(sender, args)
		{
			...
			if (HasValue(ClickedItem))
			{
				switch (ClickedItem.get_value())
				{
					...
					break;
					case "MenuItem30":
						document.getElementById('IFrame1').contentWindow.location.href='Tipo_Evento.aspx';return false;
					break;
					case "MenuItem31":
						document.getElementById('IFrame1').contentWindow.location.href='Menu_Baile.aspx';return false;
					break;
					case "MenuItem32":
						document.getElementById('IFrame1').contentWindow.location.href='Menu_Samba.aspx';return false;
					break;
					case "MenuItem33":
						document.getElementById('IFrame1').contentWindow.location.href='Menu_Balada.aspx';return false;
					break;
					case "MenuItem34":
						document.getElementById('IFrame1').contentWindow.location.href='Menu_Cinema.aspx';return false;
					break;
					case "MenuItem35":
						document.getElementById('IFrame1').contentWindow.location.href='Menu_Esporte.aspx';return false;
					break;
					case "MenuItem36":
						document.getElementById('IFrame1').contentWindow.location.href='Menu_Feira.aspx';return false;
					break;
					case "MenuItem37":
						document.getElementById('IFrame1').contentWindow.location.href='Menu_Passeio.aspx';return false;
					break;
					case "MenuItem38":
						document.getElementById('IFrame1').contentWindow.location.href='Menu_Comida.aspx';return false;
					break;
					case "MenuItem39":
						document.getElementById('IFrame1').contentWindow.location.href='Menu_Show.aspx';return false;
					break;
					case "MenuItem40":
						document.getElementById('IFrame1').contentWindow.location.href='Menu_Teatro.aspx';return false;
					break;
					case "MenuItem41":
						document.getElementById('IFrame1').contentWindow.location.href='Menu_Beleza.aspx';return false;
					break;
				}
			}
		}
